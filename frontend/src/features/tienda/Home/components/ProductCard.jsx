...
Pieza modular de interfaz (Tarjeta de Producto).
Recibe información a través de 'props' y notifica eventos hacia arriba. */
...
const ProductCard = ({ product, onOpenDetail }) => {
  ...
  // ✅ FUNCIÓN UNIFICADA: Usa onOpenDetail si existe
