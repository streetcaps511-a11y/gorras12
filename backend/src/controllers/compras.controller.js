...
const compraController = {
    ...
    createCompra: async (req, res) => {
        ...
        try {
            ...
            const { idProveedor, numeroRecibo, fecha, metodoPago, productos = [] } = req.body;
...
if (fecha) {
  ...
  console.warn('⚠️ Fecha no proporcionada, se usa la fecha actual');
            ...
            // Validar y ajustar la fecha de la compra
            // fechaValida ya está definida arriba con el ajuste automático
